...
import com.voodoo.GadgetBridgeFiles.adapter.GBDeviceAppAdapter;
import com.voodoo.GadgetBridgeFiles.impl.GBDevice;
import com.voodoo.GadgetBridgeFiles.impl.GBDeviceApp;
import com.voodoo.GadgetBridgeFiles.service.devices.pebble.PebbleProtocol;
...
public class AppManagerActivity extends GBActivity {
    public static final String ACTION_REFRESH_APPLIST
            = "com.voodoo.PRMS_MiBand.appmanager.action.refresh_applist";
