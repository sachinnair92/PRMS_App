                ...
                if (result.equals("true")) {
                    ...
                    if(count>0)
                    {
                        ...
                        for(int i=0;i<count;i++)
                        {
                            ...
                            Is_amb=doc.getElementsByTagName("Message_" + i).item(0).getChildNodes().item(5).getChildNodes().item(0).getNodeValue();

                            if(S_uname.equals(Uname))
                            {
                                messageAdapter.addMessage(msg,S_uname,S_time,MessageAdapter.DIRECTION_OUTGOING);
                            }
                            else
                            {
        ...
        ma.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result.equals("true")) {
                    ...
                    messageAdapter.addMessage(msg, Uname,timestamp, MessageAdapter.DIRECTION_OUTGOING);
                }else
                {
